<!-- README.md: project documentation for the Krishi Mitra (Kirshi-Mitra) repository -->
<!-- Reusable convention: use Markdown headings, bold, and lists instead of inline HTML -->
...
<!-- Index of files available in this repository -->
## 📂 Repository Contents
...
1. AI-powered insights for crop health & soil condition
2. Weather-based alerts using IMD APIs
3. Community-driven discussions & knowledge sharing
...
5. **AI/ML:** Crop & soil prediction models
